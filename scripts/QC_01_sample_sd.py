...
args = parser.parse_args(["--infile","/net/eichler/vol8/home/nkrumm/EXOMES/ESP2000/SVD/ESP.BROAD.SVD40.QC.SampleQC.hdf5", "--outfile","test.sd.txt", "--plotfile","test.png", "--verbose"])
